...
var PRODUCTS = [
  ...
  { id:'bulb-8mp-e27', variantId:50741149106316, name:'מצלמת נורה 8MP | זום 8x | עדשה כפולה | WiFi E27', price:389, badge:'קל להרכבה', cat:'אינדור',
    ...
    desc:'מצלמת אבטחה בצורת נורה — 8MP עם זום 8x ועדשה כפולה (רחב + זום במקביל). מתחברת לכל בסיס E27 (שקע נורה רגיל) תוך שניות, מעקב אוטומטי אחרי תנועה, שמע דו-כיווני. ₪389 למצלמה אחת | ₪699 לשתיים | ₪989 לשלוש.',
