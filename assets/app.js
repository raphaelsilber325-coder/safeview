...
var PRODUCTS = [
  ...
  { id:'solar-3mp', variantId:50367695028364, name:'מצלמת אבטחה סולארית חיצונית 3MP | זיהוי AI | IP65', price:99, badge:'סולארי', cat:'סולאריות',
    ...
    desc:'מצלמת אבטחה סולארית חיצונית ב-₪99 — זיהוי AI חכם של בני אדם (לא התראות שווא מחתולים), ראיית לילה צבעונית ושמע דו-כיווני. ללא חיווט, ללא חשמל, חיסכון מלא. מתאים לחצר, גג ושער.',
  ...
  { id:'wifi-ir', variantId:50367695224972, name:'מצלמת אבטחה WiFi | אינפרא-אדום | Smart Home', price:35, badge:'אאוטדור', cat:'אאוטדור',
    ...
    desc:'מצלמת אבטחה WiFi זולה ב-₪35 בלבד — ראיית לילה אינפרא-אדום, זיהוי תנועה, צפייה מרחוק מהנייד. הדרך הכי משתלמת להתחיל לאבטח את הבית. התקנה פשוטה ב-3 דקות, ללא צורך בטכנאי.',
  ...
  { id:'mini-1080', variantId:50367694504076, name:'מצלמת מיני אלחוטית 1080P | ראיית לילה', price:39, badge:'מיני', cat:'מיני',
    ...
    desc:'מצלמת מיני נסתרת Full HD 1080P ב-₪39 — ראיית לילה, זיהוי תנועה, גוף קטן במיוחד שמתחבא בכל מקום. מושלם למעקב אחרי בייביסיטר, עובדים, חיות מחמד ורכוש. חיבור USB פשוט, אין צורך בטכנאי.',
  ...
  { id:'mini-4k', variantId:50367695257740, name:'מצלמת מיני 4K WiFi | ניטור פנימי חכם', price:29, badge:'מיני', cat:'מיני',
    ...
    desc:'מצלמת מיני נסתרת ב-₪29 — איכות 4K, גוף קטן במיוחד, ניידת לחלוטין. גישה מרחוק מהסמארטפון בכל מקום. אבטחה דיסקרטית לבית, משרד, חנות ורכב. המצלמה הזולה ביותר שלנו.',
  ...
  { id:'outdoor-3mp-wifi', variantId:50697567961228, name:'מצלמת חיצונית 3MP WiFi | ניטור חצר ובית', price:129, badge:'אאוטדור', cat:'אאוטדור',
    ...
    desc:'מצלמת אבטחה WiFi חיצונית 3MP — תמונה חדה 1296P, עמידה לגשם ושמש, מושלמת לניטור חצר, גינה, חניה ושער. התקנה פשוטה וצפייה מרחוק מהנייד. פתרון חיצוני אמין ומשתלם לכל בית.',
