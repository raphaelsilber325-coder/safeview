...
var PRODUCT_REVIEWS = {
  'baseus-s1': [
    ...
    {name:'שירה מ.',rating:5,date:'2026-04-08',title:'קניתי 3 - כיסוי מלא לוילה',text:'התקנתי בחזית, חצר אחורית וכניסה. שולטת על כולן מהפלאפון. שווה כל שקל. המשלוח הגיע תוך כ-3 שבועות כמו שצוין.',verified:true},
