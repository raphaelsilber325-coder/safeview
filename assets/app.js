...
var PRODUCTS = [
  ...
  { id:'mini-1080', variantId:50740844331148, name:'מצלמת מיני אלחוטית 1080P | ראיית לילה', price:39, badge:'מיני', cat:'מיני',
    ...
    desc:'מצלמת מיני נסתרת 1080P Full HD — קטנה, סודית ומקצועית. חדה ביום ובלילה עם ראיית לילה אינפרא-אדום. זיהוי תנועה חכם שמקליט רק כשיש פעילות — חיסכון באחסון. חיבור WiFi פשוט דרך אפליקציה. מושלם לבייביסיטרים, עובדים, חיות מחמד ומשרדים ביתיים. מתחבר לכל מטען USB רגיל — אין צורך בטכנאי. ₪39 למצלמה אחת | ₪70 לשתיים | ₪99 לשלוש.',
  ...
  { id:'mini-4k', variantId:50740844462220, name:'מצלמת מיני 4K WiFi | ניטור פנימי חכם', price:29, badge:'מיני', cat:'מיני',
    ...
    desc:'מצלמת מיני ב-₪29 — הכי קטנה, הכי זולה, ועם איכות 4K מפתיעה. ניידת לחלוטין, מתחברת ל-WiFi ביתי ומאפשרת גישה מרחוק מהסמארטפון בכל מקום בעולם. אבטחה דיסקרטית שלא רואים — בית, משרד, חנות ורכב. המצלמה הזולה ביותר שלנו. ₪29 למצלמה אחת | ₪52 לשתיים | ₪74 לשלוש.',
  ...
  { id:'mini-portable-wifi', variantId:50747409268876, name:'מצלמה מיני נייד | WiFi | ניטור ביתי קומפקטי', price:117, badge:'חדש', cat:'מיני',
    img:'https://cdn.shopify.com/s/files/1/0774/8098/4716/files/Sbc0a0f503bef4da38aa8afb66892d1a6j.webp',
    desc:'מצלמה קומפקטית ונשיאה בכל מקום — מתחברת ל-WiFi ומנטרת בזמן אמת דרך הטלפון. עיצוב קטן ודיסקרטי, ראיית לילה, זיהוי תנועה עם התראות פוש. מושלמת לבית, משרד וניטור ילדים.',
    specs:[['גודל','קומפקטי ונייד'],['חיבור','WiFi'],['ראיית לילה','IR'],['זיהוי תנועה','כן + התראות'],['ניטור','מרחוק דרך אפליקציה']] },
