...
var PRODUCTS = [
  ...
  { id:'solar-3mp', variantId:50367695028364, name:'מצלמת אבטחה סולארית חיצונית 3MP | זיהוי AI | IP65', price:99, badge:'סולארי', cat:'סולאריות',
    ...
    variants:[
      {id:50367695028364, title:'מצלמה אחת', price:99},
      {id:50367695028364, title:'2 מצלמות', price:180},
      {id:50367695028364, title:'3 מצלמות', price:259}
    ],
    desc:'מצלמת אבטחה סולארית חיצונית ב-₪99 — זיהוי AI חכם של בני אדם (לא התראות שווא מחתולים), ראיית לילה צבעונית ושמע דו-כיווני. ללא חיווט, ללא חשמל, חיסכון מלא. מתאים לחצר, גג ושער. ₪99 למצלמה אחת | ₪180 לשתיים | ₪259 לשלוש.',
  ...
  { id:'indoor-2k', variantId:50367694667916, name:'מצלמת אבטחה פנימית 2K | AI + שיחה דו-כיוונית | Blurams', price:45, badge:'אינדור', cat:'אינדור',
    ...
    variants:[
      {id:50367694667916, title:'מצלמה אחת', price:45},
      {id:50367694667916, title:'2 מצלמות', price:82},
      {id:50367694667916, title:'3 מצלמות', price:115}
    ],
    desc:'מצלמת אבטחה פנימית עם בינה מלאכותית — מזהה אנשים וחיות מחמד. שיחה דו-כיוונית בלחיצה אחת. מושלם למשפחות ולחיות מחמד. ₪45 למצלמה אחת | ₪82 לשתיים | ₪115 לשלוש.',
  ...
  { id:'flagship-16mp', variantId:50367695159436, name:'מצלמת אבטחה חיצונית 16MP 8K | 360° | 4 עדשות', price:359, badge:'פלאגשיפ', cat:'אינדור',
    ...
    variants:[
      {id:50367695159436, title:'מצלמה אחת', price:359},
      {id:50367695159436, title:'2 מצלמות', price:650},
      {id:50367695159436, title:'3 מצלמות', price:930}
    ],
    desc:'המצלמה המתקדמת ביותר שלנו — 16MP, 8K אמיתי, 4 עדשות שמסתובבות 360°, זום 10x וזיהוי AI. מערכת אבטחה מקצועית בקופסה אחת. ₪359 למצלמה אחת | ₪650 לשתיים | ₪930 לשלוש.',
  ...
  { id:'wifi-dual', variantId:50367694700684, name:'מצלמת WiFi חיצונית | עדשה כפולה 3MP | ICSee', price:69, badge:'אאוטדור', cat:'אאוטדור',
    ...
    variants:[
      {id:50367694700684, title:'מצלמה אחת', price:69},
      {id:50367694700684, title:'2 מצלמות', price:125},
      {id:50367694700684, title:'3 מצלמות', price:179}
    ],
    desc:'מצלמה חיצונית עם עדשה כפולה — תצוגה רחבה וזום במקביל. תמונה חדה של 3MP, עמידות מלאה למזג אוויר, אפליקציית ICSee היציבה. ₪69 למצלמה אחת | ₪125 לשתיים | ₪179 לשלוש.',
  ...
  { id:'wifi-ir', variantId:50367695224972, name:'מצלמת אבטחה WiFi | אינפרא-אדום | Smart Home', price:35, badge:'אאוטדור', cat:'אאוטדור',
    ...
    variants:[
      {id:50367695224972, title:'מצלמה אחת', price:35},
      {id:50367695224972, title:'2 מצלמות', price:64},
      {id:50367695224972, title:'3 מצלמות', price:89}
    ],
    desc:'מצלמת אבטחה WiFi זולה ב-₪35 בלבד — ראיית לילה אינפרא-אדום, זיהוי תנועה, צפייה מרחוק מהנייד. הדרך הכי משתלמת להתחיל לאבטח את הבית. התקנה פשוטה ב-3 דקות, ללא צורך בטכנאי. ₪35 למצלמה אחת | ₪64 לשתיים | ₪89 לשלוש.',
  ...
  { id:'mini-1080', variantId:50367694504076, name:'מצלמת מיני אלחוטית 1080P | ראיית לילה', price:39, badge:'מיני', cat:'מיני',
    ...
    variants:[
      {id:50367694504076, title:'מצלמה אחת', price:39},
      {id:50367694504076, title:'2 מצלמות', price:70},
      {id:50367694504076, title:'3 מצלמות', price:99}
    ],
  ...
  { id:'mini-4k', variantId:50367695257740, name:'מצלמת מיני 4K WiFi | ניטור פנימי חכם', price:29, badge:'מיני', cat:'מיני',
    ...
    variants:[
      {id:50367695257740, title:'מצלמה אחת', price:29},
      {id:50367695257740, title:'2 מצלמות', price:52},
      {id:50367695257740, title:'3 מצלמות', price:74}
    ],
  ...
  { id:'ease-life-bulb', variantId:50697567436940, name:'מצלמת נורה חיצונית | WiFi 5GHz | 360° | בסיס E27', price:199, badge:'אאוטדור', cat:'אאוטדור',
    ...
    variants:[
      {id:50697567436940, title:'מצלמה אחת', price:199},
      {id:50697567436940, title:'2 מצלמות', price:360},
      {id:50697567436940, title:'3 מצלמות', price:510}
    ],
    desc:'מצלמת אבטחה מיוחדת בצורת נורה — מתחברת לכל בסיס E27 (שקע נורה רגיל). WiFi מהיר 5GHz, סיבוב 360° וראיית לילה. ללא חיווט נוסף. ₪199 למצלמה אחת | ₪360 לשתיים | ₪510 לשלוש.',
  ...
  { id:'outdoor-3mp-wifi', variantId:50697567961228, name:'מצלמת חיצונית 3MP WiFi | ניטור חצר ובית', price:129, badge:'אאוטדור', cat:'אאוטדור',
    ...
    variants:[
      {id:50697567961228, title:'מצלמה אחת', price:129},
      {id:50697567961228, title:'2 מצלמות', price:234},
      {id:50697567961228, title:'3 מצלמות', price:335}
    ],
  ...
  { id:'tuya-5g-5mp', variantId:50697568288908, name:'מצלמת WiFi 5G | 5MP | AI מעקב אוטומטי | Tuya Smart', price:499, badge:'אאוטדור', cat:'אאוטדור',
    ...
    variants:[
      {id:50697568288908, title:'מצלמה אחת', price:499},
      {id:50697568288908, title:'2 מצלמות', price:899},
      {id:50697568288908, title:'3 מצלמות', price:1290}
    ],
  ...
  { id:'ls-vision-solar-4g', variantId:50697568944268, name:'מצלמת LS VISION סולארית 4G | 8MP 4K | PTZ | V380 Pro', price:699, badge:'סולארי', cat:'סולאריות',
    ...
    variants:[
      {id:50697568944268, title:'מצלמה אחת', price:699},
      {id:50697568944268, title:'2 מצלמות', price:1259},
      {id:50697568944268, title:'3 מצלמות', price:1799}
    ],
  ...
  { id:'zumimall-f5', variantId:50697568845964, name:'מצלמת ZUMIMALL F5 | סוללה מגנטית | WiFi 2.4G | 3MP', price:399, badge:'אאוטדור', cat:'אאוטדור',
    ...
    variants:[
      {id:50697568845964, title:'מצלמה אחת', price:399},
      {id:50697568845964, title:'2 מצלמות', price:720},
      {id:50697568845964, title:'3 מצלמות', price:1039}
    ],
  ...
  { id:'okam-solar-ptz', variantId:50697572515980, name:'מצלמת O-Kam Solar | 8MP 4K | זום 10x | PTZ אוטומטי', price:999, badge:'סולארי', cat:'סולאריות',
    ...
    variants:[
      {id:50697572515980, title:'מצלמה אחת', price:999},
      {id:50697572515980, title:'2 מצלמות', price:1799},
      {id:50697572515980, title:'3 מצלמות', price:2599}
    ],
  ...
  { id:'annke-5mp-bullet', variantId:50697572778124, name:'מצלמת ANNKE 5MP | תאורה חכמה | בולט | IP67', price:369, badge:'אאוטדור', cat:'אאוטדור',
    ...
    variants:[
      {id:50697572778124, title:'מצלמה אחת', price:369},
      {id:50697572778124, title:'2 מצלמות', price:670},
      {id:50697572778124, title:'3 מצלמות', price:960}
    ],
  ...
  { id:'annke-nvr-kit', variantId:50697573040268, name:'ערכת ANNKE | NVR 4 ערוצים + מצלמות WiFi 3MP/5MP | IP66', price:269, badge:'מערכת', cat:'מערכות',
    img:'https://cdn.shopify.com/s/files/1/0774/8098/4716/files/S1e83550a8b8744e4beccce5ab55b9034E.webp?v=1781270988',
    variants:[
      {id:50697573040268, title:'2 מצלמות | 3MP', price:269},
      {id:50697573040268, title:'2 מצלמות | 5MP', price:299},
      {id:50697573040268, title:'4 מצלמות | 3MP', price:419},
      {id:50697573040268, title:'4 מצלמות | 5MP', price:469}
    ],
    desc:'ערכת אבטחה מלאה עם NVR + מצלמות — 4 ערוצים, מצלמות WiFi ב-3MP או 5MP לבחירה, IP66 עמידות לגשם, ראיית לילה IR. ₪269 ל-2 מצלמות 3MP | ₪299 ל-2 מצלמות 5MP | ₪419 ל-4 מצלמות 3MP | ₪469 ל-4 מצלמות 5MP.',
  ...
  { id:'ptz-15mp-8k', variantId:50697573597324, name:'מצלמת PTZ 15MP 8K | זום 10x | 3 עדשות | WiFi 5G', price:329, badge:'אאוטדור', cat:'אאוטדור',
    ...
    variants:[
      {id:50697573597324, title:'מצלמה אחת', price:329},
      {id:50697573597324, title:'2 מצלמות', price:599},
      {id:50697573597324, title:'3 מצלמות', price:849}
    ],
